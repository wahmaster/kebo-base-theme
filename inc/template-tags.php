            ...
            case 'trackback' :
                ...
                <li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
                    <article id="comment-<?php comment_ID(); ?>" class="comment">
                        ...
                        <?php printf(__('%s', 'kebo'), sprintf('<cite class="fn comment-author">%s</cite>', get_comment_author_link())); ?>
                            <time datetime="<?php comment_time('c'); ?>">
                                <?php echo kebo_time_ago( get_comment_date('G') ); ?>
                            </time>
                            <a class="comment-id" href="<?php echo esc_url(get_comment_link($comment->comment_ID)); ?>">#<?php echo $comment->comment_ID; ?></a>
